          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.id}>
                ...
                <td style={td}><input style={{ ...cellInput, width: 110 }} type="number" min="0" value={r.unitPrice} onChange={(e) => updateItem(r.id, "unitPrice", e.target.value)} placeholder="60000" /></td>
