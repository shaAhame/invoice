...
function emptyItem() {
  return { id: Math.random().toString(36).slice(2), description: "", qty: 1, unitPrice: "" };
}
...
export default function NewInvoicePage() {
  ...
  // unitPrice is always the FINAL price the customer pays per unit — whatever
  // taxes are on for this invoice are baked into that number, and we work
  // backwards to split it into base / SSCL / VAT. This means the number typed
  // here never changes when the SSCL toggle is flipped.
  const VAT_RATE = 0.18;
