...
// Three ways a line item's price can be entered — chosen per item, not per invoice.
export const PRICING_MODES = [
  { value: "mrp", label: "MRP (price already includes 18% VAT)" },
  { value: "vat", label: "+ VAT 18% (price is before tax)" },
  { value: "sscl_vat", label: "+ SSCL 2.5% + VAT 18% (price is before tax)" },
];
